...
RPCMethod name_list();
RPCMethod name_new();
RPCMethod name_firstupdate();
RPCMethod name_update();
RPCMethod queuerawtransaction();
RPCMethod dequeuetransaction();
RPCMethod listqueuedtransactions();
RPCMethod sendtoname();
