...
UniValue blockheaderToJSON(const node::BlockManager& blockman, const CBlockIndex& tip, const CBlockIndex& blockindex, uint256 pow_limit) LOCKS_EXCLUDED(cs_main);
