...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    CFeeRate feeRate;
    feeRate = CFeeRate(1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000001 NMC/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::BTC_KVB), "0.00000001 NMC/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::SAT_VB), "0.001 sat/vB");

    feeRate = CFeeRate(0);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000000 NMC/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::BTC_KVB), "0.00000000 NMC/kvB");
    ...
    feeRate = CFeeRate(-1000);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "-0.00001000 NMC/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeRateFormat::SAT_VB), "-1.000 sat/vB");

    feeRate = CFeeRate(-COIN - 1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "-1.00000001 NMC/kvB");
