...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def test_headers_not_synced(self, valid_snapshot_path):
        for node in self.nodes[1:]:
            msg = "Unable to load UTXO snapshot: The base block header (679788f89317d60dd751bf6d9829864f074a77be5bca9084237ac9be116c4e3f) must appear in the headers chain. Make sure all headers are syncing, and call loadtxoutset again."
    ...
    def test_snapshot_block_invalidated(self, dump_output_path):
        ...
        for height in [SNAPSHOT_BASE_HEIGHT, SNAPSHOT_BASE_HEIGHT - 1]:
            ...
            msg = "Unable to load UTXO snapshot: The base block header (679788f89317d60dd751bf6d9829864f074a77be5bca9084237ac9be116c4e3f) is part of an invalid chain."
            assert_raises_rpc_error(-32603, msg, node.loadtxoutset, dump_output_path)
    ...
    def run_test(self):
        ...
        print (n0.getblockcount ())
        print (n0.getbestblockhash ())
