...
class WalletV3Test(BitcoinTestFramework):
    ...
    def truc_tx_with_conflicting_sibling(self):
        ...
        outputs = {self.alice.getnewaddress() : alice_unspent['amount'] - Decimal(0.00001020)}
    ...
    def truc_tx_with_conflicting_sibling_change(self):
        ...
        outputs = {self.bob.getnewaddress() : bob_unspent['amount'] - Decimal(0.00001020)}
    ...
    def v3_conflict_removed_from_mempool(self):
        ...
        assert_equal(self.charlie.gettransaction(txid, verbose=True)["decoded"]["version"], 1)
        self.generate(self.nodes[0], 1)
        ...
        outputs = {self.charlie.getnewaddress() : alice_v2_unspent['amount'] + alice_unspent['amount'] - Decimal(0.00050120)}
        ...
        outputs = {self.charlie.getnewaddress() : alice_v2_unspent['amount'] - Decimal(0.00105120)}
