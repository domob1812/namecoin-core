...
class NameScanningTest (NameTestFramework):
  ...
  def run_test (self):
    ...
    self.checkNameData (scan[1], "aa", "value aa", -4, True)
    self.checkNameData (scan[2], "b", "value b", -4, True)
    self.checkNameData (scan[3], "c", "value c", 11, False)

    # Check for expected names in various name_scan calls.
    self.checkList (self.nodes[3].name_scan (), ["a", "aa", "b", "c"])
    ...
    self.checkList (self.nodes[3].name_scan ("", 2), ["a", "aa"])
    ...
    self.checkList (self.nodes[3].name_filter (), ["a", "aa","b", "c"])
    self.checkList (self.nodes[3].name_filter ("[ac]"), ["a", "aa", "c"])
    ...
    self.checkList (self.nodes[3].name_filter ("", 0, 1, 4), ["aa", "b", "c"])
